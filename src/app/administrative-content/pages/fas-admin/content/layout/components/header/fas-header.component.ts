...
import {FASNAVIGATION, NAVIGATION} from "../../../../../../../core/navigation/navigation-data";
...
@Component({
  selector: 'app-fas-header',
  templateUrl: './header.component.html',
  styleUrls: ['./header.component.scss'],
})
export class FasHeaderComponent implements OnInit, AfterViewInit, OnDestroy {

  sideBar: any;
  quickSidebar: any;
   navigation = FASNAVIGATION;
  breadcrumbs: any[] = [];
  ...
  ngOnInit() {
    this.componenRegistryService.onRegistryChanged
      ...
      .subscribe(registry => {
        this.sideBar = this.componenRegistryService.getComponent('fas-sidenav');
        this.quickSidebar = this.componenRegistryService.getComponent('fas-quick-sidebar');
