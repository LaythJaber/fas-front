...
import {Ds} from "../../../../../../../../../shared/models/ds";
...
export class DsTabComponent implements OnInit {
  ...
  initForm() {
    ...
    this.formArray?.get([0]).patchValue(this.ds);
    this.formArray?.get([1]).patchValue(this.ds);
    this.formArray?.get([2]).patchValue(this.ds);
    this.formArray?.get([3]).patchValue(this.ds);
    this.formArray?.get([4]).patchValue(this.ds);
    this.formArray?.get([5]).patchValue(this.ds);
    this.formArray?.get([6]).patchValue(this.ds);
    this.formArray?.get([7]).patchValue(this.ds);
    this.formArray?.get([8]).patchValue(this.ds);
  }
}
